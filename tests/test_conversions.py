...
#     fff_lattice = cf.import_fff_from_cpymad(madx_lattice)
#     pyat_lattice = cf.export_pyat_from_fff(fff_lattice)
#     fff_lattice_new = cf.import_fff_from_pyat(pyat_lattice)
#     madx_lattice_new = cf.export_cpymad_from_fff(fff_lattice_new)
#     madx_lattice.use('l000013')
#     madx_lattice_new.use('l000013')
#     twiss = madx_lattice.twiss(sequence='l000013')
#     twiss_new = madx_lattice_new.twiss(sequence='l000013')
...
#     fff_lattice = cf.import_fff_from_pyat(pyat_lattice)
#     madx_lattice = cf.export_cpymad_from_fff(fff_lattice)
#     fff_lattice_new = cf.import_fff_from_cpymad(madx_lattice)
#     pyat_lattice_new = cf.export_pyat_from_fff(fff_lattice_new)
#     lin, s = get_optics_pyat(pyat_lattice, radiation=False)
#     lin_new, s_new = get_optics_pyat(pyat_lattice_new, radiation=False)
#     return lin, lin_new, s, s_new
# 
