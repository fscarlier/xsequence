...
def example_cpymad_fff_pyat_fff_cpymad():
    ...
    pyat_lattice = cf.create_pyat_from_lattice(fff_lattice)
    fff_lattice_new = cf.import_lattice_from_pyat(pyat_lattice)
    madx_lattice_new = cf.create_cpymad_from_lattice(fff_lattice_new)
...
def example_pyat_fff_cpymad_fff_pyat():
    ...
    madx_lattice = cf.create_cpymad_from_lattice(fff_lattice)
    fff_lattice_new = cf.import_lattice_from_cpymad(madx_lattice)
    pyat_lattice_new = cf.create_pyat_from_lattice(fff_lattice_new)
