...
@mark.parametrize('el1, el2',
                 [(BaseElement('el_0'),                                      BaseElement('el_0')   ),
                  ...
                  (SectorBend('el_9', length=2.0, angle=0.3),                     SectorBend('el_9', length=2.0, angle=0.3)   ),
                  (SectorBend('el_10', length=2.0, angle=0.3, e1=0.01, e2=0.011), SectorBend('el_10', length=2.0, angle=0.3, e1=0.01, e2=0.011)   ),
                 ])
