...
# Import from sad sequence file
lat = Lattice.from_sad("FCCee_h.sad", 'ring', energy=120)
...
fig, ax = fcc_axes()
ax.plot(df_mad['s'], df_mad['betx'], label='mad-x')
ax.plot(df_pyat['s'], df_pyat['betx'], label='pyat')
ax.legend()
plt.show()
...
# The dependencies package from R. de Maria has been implemented into Lattices to import dependencies from cpymad. 
# 
